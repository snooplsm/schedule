...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public synchronized SQLiteDatabase getReadableDatabase() {		
		SharedPreferences prefs = context.getSharedPreferences("database_info", Context.MODE_PRIVATE);
	...
	private void copyDatabaseTo(File database) throws IOException {
		...
		try {
			...
			for (String partition : partions) {
				final InputStream in = context.getAssets().open("database/" + partition);
				int read;
		...
		String[] replacements = context.getResources().getStringArray(R.array.replacement_names);
		db.beginTransaction();
