...
public abstract class DateSlider extends Dialog {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		todayButton.setText(getTodayText());
		todayButton.setOnClickListener(newTodayListener());
	...
	private android.view.View.OnClickListener todayButtonClickListener = new android.view.View.OnClickListener() {
		public void onClick(View v) {
			if (onDateSetListener != null) {
				onDateSetListener.onDateSet(DateSlider.this,
	...
	protected android.view.View.OnClickListener newTodayListener() {
		return todayButtonClickListener;
	}

	public void setTime(Calendar cal) {
		mTime.setTimeInMillis(cal.getTimeInMillis());
		for (ScrollLayout sl : mScrollerList) {
			sl.setTime(mTime.getTimeInMillis(), 1);
		}
	}
